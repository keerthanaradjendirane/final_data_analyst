...
if "data" in st.session_state and menu == "Data Visualization":
    ...
    visualization_type = st.radio(
        ...
        [
            ...
            "Histogram", "Box Plot", "Violin Plot", "Pair Plot", 
            "Correlation Heatmap", "FacetGrid"
        ], 
    ...
    if st.button("Generate Graph", key="generate_graph"):
        ...
        # Pair Plot (scatterplot matrix for all columns)
